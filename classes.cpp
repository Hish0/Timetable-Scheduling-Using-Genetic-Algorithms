...
int main()
{
    ...
    // Initialize Modules
    Module module1(1, lecturer1, "Math", 2, 25, false);
    Module module2(2, lecturer2, "Physics", 1, 35, true);

    // Initialize ScheduledModules
    ScheduledModule scheduledModule1(module1, timeSlot1, venue1, false, false, true);
    ScheduledModule scheduledModule2(module1, timeSlot3, venue1, false, false, true); // Should violate the constraint
    ScheduledModule scheduledModule3(module2, timeSlot2, venue1, false, false, true);
    ScheduledModule scheduledModule4(module2, timeSlot1, venue2, false, false, true);
