...
for gene_block in gene_blocks:
    ...
    # Update timetable dictionary with colored module name
    module_info = f'<span style="color:{color}">{module_name}-{lecturer_name}</span>'
    ...
    cell_content = f'{module_info}-{venue_name}'
...
with open('all_timetables_colored.html', 'w') as f:
    f.write(final_html)
